...
中文版，以維持系列譯名的一致性；部分詞條另有個別參考來源，會在備註
與「翻譯參考與致謝」中說明。標記為「暫譯」的項目尚未完成最終確認，
後續版本可能調整。
...
| 英文名稱 | 採用譯名 | 備註 |
| --- | --- | --- |
| Tinkerbat / Tinkerbats | 叮咯鬼 | 單複數共用；參考《Shantae》無印漢化包（CodeBay.IN 出品） |
...
- 部分系列譯名參考《Shantae and the Seven Sirens》的官方繁體中文版。
- `Tinkerbat / Tinkerbats` 的「叮咯鬼」譯名參考《Shantae》無印漢化包（CodeBay.IN 出品）。
